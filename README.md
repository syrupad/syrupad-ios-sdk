...
```
![ats exception](http://syrupad.github.io/syrupad-ios-sdk/readme-screenshots/ats_exception.png)

**이후 앱 등록 심사 요청 시에 하단의 스크린 샷 영역인 `App 심사 정보` 항목 중 `메모` 영역에 다음과 같이 내용을 추가하여 주십시오.**

`본 앱에서 사용하고 있는 광고 플랫폼 SDK가 http protocol을 사용하고 있어 예외처리함`
![memo](http://syrupad.github.io/syrupad-ios-sdk/readme-screenshots/memo.png)
